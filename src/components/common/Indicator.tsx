...
const Indicator = ({ shirtType }: { shirtType: ShirtType }) => {
  ...
  return (
    <div
      className={clsx(
        "fixed flex flex-col items-center z-10 bottom-16 left-1/2 -translate-x-1/2 gap-5 transition-opacity duration-500",
    ...
    >
      ...
      <div
        className={clsx(
          "uppercase md:text-sm text-xs tracking-wider",
          shirtType === "white" ? "text-black" : "text-white"
        )}
      >
        Scroll to explore
