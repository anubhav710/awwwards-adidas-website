"use client";
import { MainStudioModel } from "@/components/models/MainStudioModel";
...
export default function Home() {
  ...
  return (
    <>
      ...
      <p className="absolute z-10 top-11/12 place-self-center md:text-xs text-[10px] font-medium tracking-wider text-white/80 uppercase">
